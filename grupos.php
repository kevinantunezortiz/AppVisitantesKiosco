...
<body>
  <div id="contenedor">
    <div class="row m-2">
      <div class="col">
        <h6>Infancias/Adolescentes</h6>
        <div class="row mb-2">
          <div class="col">
            <label for="hombres1" class="form-label">Hombres</label>
            <input id="hombres1" type="number"  readonly class="form-control text-center" />
          </div>
          <div class="col">
            <label for="mujeres1" class="form-label">Mujeres</label>
        ...
        <div class="row mb-2">
          <div class="col">
            <label for="hombres2" class="form-label">Hombres</label>
            <input id="hombres2" type="number"  readonly class="form-control text-center" />
          </div>
          <div class="col">
            <label for="mujeres2" class="form-label">Mujeres</label>
        ...
        <div class="row">
          <div class="col">
            <label for="hombres3" class="form-label">Hombres</label>
            <input id="hombres3" type="number"  readonly class="form-control text-center" />
          </div>
          <div class="col">
            <label for="mujeres3" class="form-label">Mujeres</label>
            <input id="mujeres3" type="number"  readonly class="form-control text-center" />
          </div>       
        </div>
        <div class="row">
             <button id="btnregistrargrupo" class="btn btn-success">Registrar Grupo</button>
        </div>
      </div>
